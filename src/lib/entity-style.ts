...
export const ENTITY_BADGE_CLASSES: Record<string, string> = {
  person: "bg-[#7fb5a0]/20 text-[#435f54] dark:text-[#7fb5a0] border border-[#7fb5a0]/30",
  organization: "bg-[#c8956b]/20 text-[#7b563c] dark:text-[#c8956b] border border-[#c8956b]/30",
  group: "bg-[#6b9e8a]/20 text-[#3d5f53] dark:text-[#6b9e8a] border border-[#6b9e8a]/30",
  ring: "bg-[#9b8ec4]/20 text-[#5d5577] dark:text-[#9b8ec4] border border-[#9b8ec4]/30",
  family: "bg-[#d4a57b]/20 text-[#805b3c] dark:text-[#d4a57b] border border-[#d4a57b]/30",
  event: "bg-[#c47a7a]/20 text-[#7a4949] dark:text-[#c47a7a] border border-[#c47a7a]/30",
  post: "bg-[#7a9ebd]/20 text-[#476178] dark:text-[#7a9ebd] border border-[#7a9ebd]/30",
  note: "bg-[#7a9ebd]/20 text-[#476178] dark:text-[#7a9ebd] border border-[#7a9ebd]/30",
  listing: "bg-[#c49b7a]/20 text-[#765d48] dark:text-[#c49b7a] border border-[#c49b7a]/30",
  product: "bg-[#b8917a]/20 text-[#715744] dark:text-[#b8917a] border border-[#b8917a]/30",
  service: "bg-[#7ab5a8]/20 text-[#45695f] dark:text-[#7ab5a8] border border-[#7ab5a8]/30",
  voucher: "bg-[#d4a57b]/20 text-[#805b3c] dark:text-[#d4a57b] border border-[#d4a57b]/30",
  ticket: "bg-[#c98bad]/20 text-[#785166] dark:text-[#c98bad] border border-[#c98bad]/30",
  badge: "bg-[#c8a84b]/20 text-[#766327] dark:text-[#c8a84b] border border-[#c8a84b]/30",
  task: "bg-[#b5b89b]/20 text-[#66684f] dark:text-[#b5b89b] border border-[#b5b89b]/30",
  job: "bg-[#8b9ec4]/20 text-[#52607a] dark:text-[#8b9ec4] border border-[#8b9ec4]/30",
  project: "bg-[#9b8ec4]/20 text-[#5d5577] dark:text-[#9b8ec4] border border-[#9b8ec4]/30",
  skill: "bg-[#7ab5c4]/20 text-[#476b75] dark:text-[#7ab5c4] border border-[#7ab5c4]/30",
  venue: "bg-[#c47a7a]/20 text-[#7a4949] dark:text-[#c47a7a] border border-[#c47a7a]/30",
  bounty: "bg-[#c8956b]/20 text-[#7b563c] dark:text-[#c8956b] border border-[#c8956b]/30",
  gift: "bg-[#98c4a8]/20 text-[#54705f] dark:text-[#98c4a8] border border-[#98c4a8]/30",
  resource: "bg-[#b5a87a]/20 text-[#696044] dark:text-[#b5a87a] border border-[#b5a87a]/30",
  shift: "bg-[#a0a89b]/20 text-[#5e6459] dark:text-[#a0a89b] border border-[#a0a89b]/30",
  thanks_token: "bg-[#c98bad]/20 text-[#785166] dark:text-[#c98bad] border border-[#c98bad]/30",
  role: "bg-[#8bb5a8]/20 text-[#4f6b62] dark:text-[#8bb5a8] border border-[#8bb5a8]/30",
  offer: "bg-[#98c4a8]/20 text-[#54705f] dark:text-[#98c4a8] border border-[#98c4a8]/30",
  request: "bg-[#9bb5c4]/20 text-[#596b75] dark:text-[#9bb5c4] border border-[#9bb5c4]/30",
  agreement: "bg-[#b5917a]/20 text-[#6f5848] dark:text-[#b5917a] border border-[#b5917a]/30",
  token: "bg-[#c8a84b]/20 text-[#766327] dark:text-[#c8a84b] border border-[#c8a84b]/30",
  money: "bg-[#b5c47a]/20 text-[#667046] dark:text-[#b5c47a] border border-[#b5c47a]/30",
  asset: "bg-[#c8b84b]/20 text-[#756c29] dark:text-[#c8b84b] border border-[#c8b84b]/30",
  plan: "bg-[#b5917a]/20 text-[#6f5848] dark:text-[#b5917a] border border-[#b5917a]/30",
  training: "bg-[#c49b7a]/20 text-[#765d48] dark:text-[#c49b7a] border border-[#c49b7a]/30",
  location: "bg-[#c47a7a]/20 text-[#7a4949] dark:text-[#c47a7a] border border-[#c47a7a]/30",
  time: "bg-[#b5917a]/20 text-[#6f5848] dark:text-[#b5917a] border border-[#b5917a]/30",
  polling: "bg-[#8b9ec4]/20 text-[#52607a] dark:text-[#8b9ec4] border border-[#8b9ec4]/30",
  character: "bg-[#8bb5a8]/20 text-[#4f6b62] dark:text-[#8bb5a8] border border-[#8bb5a8]/30",
  interest: "bg-[#9b8ec4]/20 text-[#5d5577] dark:text-[#9b8ec4] border border-[#9b8ec4]/30",
  sharing: "bg-[#7ab5a8]/20 text-[#45695f] dark:text-[#7ab5a8] border border-[#7ab5a8]/30",
  gratis: "bg-[#c98bad]/20 text-[#785166] dark:text-[#c98bad] border border-[#c98bad]/30",
  story: "bg-[#8bb5a8]/20 text-[#4f6b62] dark:text-[#8bb5a8] border border-[#8bb5a8]/30",
  unknown: "bg-[#8a9a8a]/20 text-[#566156] dark:text-[#8a9a8a] border border-[#8a9a8a]/30",
}
