 ...
 * - bounded pool (`max`) prevents unbounded concurrent DB sockets,
 * - finite idle/connect timeouts avoid hung workers,
 * - prepared statements are disabled to avoid known Date binding issues in this stack.
 */
