...
export async function POST(request: NextRequest) {
  ...
  // the envelope fields (originNodeId/entityId/nonce/eventVersion) the receiver
  // needs to reconstruct and verify it. Phase 1 is emit-only.
