 ...
 *
 * - On crystalline-enabled lanes (the global runtimes; same host list the
 *   retired CrystallineVolumeBg component used, plus the
 ...
 *   layer and hides the water photo.
 * - Everywhere else (sovereign instances) it preloads the theme-correct water
 *   jpg so the photo lands with first paint instead of popping in later. The
 *   `theme` localStorage key + system fallback mirrors next-themes.
 *
