  ...
  try {
    ...
    await db
      ...
      .set({
        ...
        // Encrypt the access token at rest (EVT-SEC-006); the user id stays
        // plaintext. Legacy plaintext rows are migrated to ciphertext on this
        // next provisioning write.
