 ...
 *
 * Key props:
 * - `open`: controls visibility of the command dialog.
 * - `onOpenChange`: callback to toggle dialog open/close state.
...
const COMMANDS: CommandDefinition[] = [
  ...
  },
  {
    id: "settings",
    label: "Settings",
    description: "Open account and locale settings.",
    path: "/settings",
    group: "Navigate",
    icon: Settings,
  ...
  // ---- Locale-specific ----
  {
    id: "groups",
    label: "Groups",
    description: "Browse locale groups and organizations.",
    path: "/groups",
    group: "Locale",
    icon: Users,
  ...
  },
  {
    id: "people",
    label: "People",
    description: "Browse people in this locale.",
    path: "/people",
    group: "Locale",
    icon: User,
  ...
  // ---- Explore ----
  {
    id: "events",
    label: "Events",
    description: "Browse all locale events.",
    path: "/events",
    group: "Explore",
    icon: Compass,
  ...
  },
  {
    id: "explore",
    label: "Explore",
    description: "Discover locale content and resources.",
    path: "/explore",
    group: "Explore",
    icon: Compass,
    aliases: ["explore", "discover", "/explore"],
  },
  // ---- Create ----
  {
    id: "create-post",
...
const COMMAND_GROUP_ORDER = ["Locale", "Create", "Navigate", "Explore"] as const;
...
export function CommandBar({
  ...
  // - "Escape" clears and closes (unless scaffold is open).
  useEffect(() => {
      ...
      commands.push(
        {
          id: "group-members",
          label: "Group Members",
          description: "View members of this group.",
          path: `${pathname}/members`,
          group: "Current Page",
          icon: Users,
          aliases: ["group members", "members"],
        },
        {
          id: "group-settings",
